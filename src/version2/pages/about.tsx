  ...
  return (
    <section className="max-w-5xl mx-auto px-4 py-10">
      ...
      <div className="relative rounded-xl w-full overflow-hidden mb-10">
        <div className="relative z-10 flex flex-col justify-center items-start text-start py-[112px] px-[40px]">
          ...
          <p className="text-textPrimary mb-5">
            We are a Chennai-based web and mobile app studio dedicated to
            creating innovative and user-centric digital solutions. Our team of
            experts combines technical expertise with creative vision to deliver
            exceptional results.
          </p>
      ...
      <p className="mb-8 text-textSecondary max-w-3xl">
        ...
        digital solutions that drive growth and enhance user engagement. We
        strive to understand our clients' unique needs and deliver tailored web
        and mobile applications that exceed expectations.
      </p>
      ...
      <div className="text-center rounded-xl p-8">
        ...
        <button
          onClick={handleClick}
          className="bg-highlightBackground text-textPrimary px-6 py-2 rounded font-semibold text-base"
        >
          Get a Quote
        </button>
      </div>
